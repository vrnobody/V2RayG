...
using System.Linq;
using V2RayG.Tests.Resource.Resx;
using static V2RayG.Misc.Utils;
...
namespace V2RayG.Tests
{
    ...
    {
        static long SpeedtestTimeout = Apis.Models.Consts.Core.SpeedtestTimeout;
...
>";
        ...
        public void ExtractVless0ShareLinksTest(string text, string expected)
        {
            ...
            var links = ExtractLinks(text, Apis.Models.Datas.Enums.LinkTypes.vless);
        ...
        {
            var r = Apis.Misc.Utils.TimedDownloadTest(url, -1, 1024 * 1024, -1);
            var time = r.Item1;
            Assert.AreEqual(SpeedtestTimeout, time);

            r = Apis.Misc.Utils.TimedDownloadTest(url, -1, -1, -1);
            time = r.Item1;
        ...
        [DataTestMethod]
        [DataRow(@"{}", "")]
        [DataRow(@"{v2rayg:{env:['1','2']}}", "")]
        [DataRow(@"{v2rayg:{env:{a:'1',b:2}}}", "a:1,b:2")]
        [DataRow(@"{v2rayg:{env:{a:'1',b:'2'}}}", "a:1,b:2")]
        ...
        {
            var core = new V2RayG.Libs.V2Ray.Core(Services.Settings.Instance);
        ...
        public void GetValue_GetBoolFromString_ReturnDefault()
        {
            var json = Services.Cache.Instance.
                tpl.LoadMinConfig();
            Assert.AreEqual(default(bool), GetValue<bool>(json, "inbounds.protocol"));
        }
        ...
        public void ExtractLinks_HttpLink()
        {
            ...
            var httpsLinks = Misc.Utils.ExtractLinks(html,
                Apis.Models.Datas.Enums.LinkTypes.https);
        ...
        {
            var result = ExtractLinks(source, Apis.Models.Datas.Enums.LinkTypes.ss);
        ...
        public void ExtractLinks_FromLinksTxt()
        {
            ...
            var links = Misc.Utils.ExtractLinks(content, Apis.Models.Datas.Enums.LinkTypes.vmess);
