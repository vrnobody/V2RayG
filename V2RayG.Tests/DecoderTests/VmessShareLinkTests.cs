...
namespace V2RayG.Tests.DecoderTests
{
    [TestClass]
    public class VmessShareLinkTests
    {
        List<Tuple<Models.Datas.Vmess, string>> GenVmessTestData()
        {
            ...
            var linkStandard = vmessStandard.ToShareLink();
            ...
            var linkNonStandard = vmessNonStandard.ToShareLink().Replace(@"=", @"");
        ...
        public void VmessDecoderTest()
        {
            ...
            var cache = V2RayG.Services.Cache.Instance;
            var setting = Services.Settings.Instance;
            var vmessDecoder = new V2RayG.Services.ShareLinkComponents.VmessDecoder(cache);
        ...
        public void ExtractVmessLinkTest()
        {
            ...
            var extracted = Misc.Utils.ExtractLinks(
                subText, Apis.Models.Datas.Enums.LinkTypes.vmess);
        ...
        {
            var errorVmess = new V2RayG.Models.Datas.Vmess
            {
            ...
            var vmessLink = errorVmess.ToShareLink();
