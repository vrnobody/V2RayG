...
namespace V2RayG.Services
{
    class PluginsServer : BaseClasses.SingletonService<PluginsServer>
    {
        ...
        readonly Dictionary<string, Apis.Interfaces.IPlugin> plugins =
             new Dictionary<string, Apis.Interfaces.IPlugin>();
        ...
        public ReadOnlyCollection<Apis.Interfaces.IPlugin> GetAllEnabledPlugins()
        {
            var result = new List<Apis.Interfaces.IPlugin>();
        ...
        public Dictionary<string, Apis.Interfaces.IPlugin> LoadAllPlugins()
        {
            // Original design of plug-in system would load dll files from hard drive.
            // That is why loading logic looks so complex.
            var pluginList = new Dictionary<string, Apis.Interfaces.IPlugin>();
            var plugins = new List<Apis.Interfaces.IPlugin>();
        ...
        List<Models.Datas.PluginInfoItem> GetPluginInfoFrom(
            Dictionary<string, Apis.Interfaces.IPlugin> pluginList)
        {
        ...
        {
            Apis.Libs.Sys.FileLogger.Info("PluginsServer.Cleanup() begin");
            CleanupPlugins(plugins.Keys.ToList());
            plugins.Clear();
            vgcApis.Dispose();
            Apis.Libs.Sys.FileLogger.Info("PluginsServer.Cleanup() done");
        }
        #endregion
    }
}
