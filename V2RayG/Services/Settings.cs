...
namespace V2RayG.Services
{
    public class Settings :
        ...
        Apis.Interfaces.Services.ISettingsService
    {
        ...
        Settings()
        {
            ...
            janitor = new Apis.Libs.Tasks.LazyGuy(
                () => GC.Collect(),
                Apis.Models.Consts.Intervals.LazyGcDelay,
                5000)
            {
                Name = "Settings.GC()",
            };
            ...
            lazyBookKeeper = new Apis.Libs.Tasks.LazyGuy(
                ...
                Apis.Models.Consts.Intervals.LazySaveUserSettingsDelay,
                500)
            {
        ...
        public Apis.Models.Datas.Enums.ShutdownReasons GetShutdownReason() => shutdownReason;

        public void SetShutdownReason(Apis.Models.Datas.Enums.ShutdownReasons reason)
        {
            Apis.Libs.Sys.FileLogger.Warn($"change shutdow reason to: {reason.ToString()}");
        ...
        {
            get => Apis.Misc.Utils.Clamp(userSettings.ImportOptions.Mode, 0, 4);
            set
            {
                userSettings.ImportOptions.Mode = Apis.Misc.Utils.Clamp(value, 0, 4);
                SaveSettingsLater();
            }
        }
        ...
        public void SavePluginsSetting(string pluginName, string value)
        {
            ...
            lock (pluginsSettingWriteLock)
            {
                ...
                try
                {
                    ...
                    userSettings.CompressedUnicodePluginsSetting = Apis.Libs.Infr.ZipExtensions
        ...
        public List<Apis.Models.Datas.CoreInfo> LoadCoreInfoList()
        {
            ...
            if (coreInfos == null)
            {
                return new List<Apis.Models.Datas.CoreInfo>();
            }
        ...
        public void SaveServerList(List<Apis.Models.Datas.CoreInfo> coreInfoList)
        {
            ...
            string ucs = Apis.Libs.Infr.ZipExtensions.SerializeObjectToCompressedUnicodeBase64(cil);
        ...
        void UpdateFileLoggerSetting()
        {
            ...
            {
                Apis.Libs.Sys.FileLogger.LogFilename = userSettings.DebugLogFilePath;
            }
        }
        ...
        Dictionary<string, string> DeserializePluginsSetting()
        {
            ...
            try
            {
                ...
                {
                    pluginsSetting = Apis.Libs.Infr.ZipExtensions
                        .DeserializeObjectFromCompressedUnicodeBase64
        ...
        Models.Datas.UserSettings LoadUserSettingsFromFile()
        {
            ...
            if (result == null)
            {
                result = Apis.Misc.Utils.LoadAndParseJsonFile<Models.Datas.UserSettings>(
                    Constants.Strings.BackupUserSettingsFilename);
            }
        ...
        Models.Datas.UserSettings LoadUserSettings()
        {
            ...
            {
                SetShutdownReason(Apis.Models.Datas.Enums.ShutdownReasons.Abort);
            }
        ...
        {
            Apis.Libs.Sys.FileLogger.Info("Settings.Cleanup() begin");
            lazyBookKeeper?.Dispose();
            SaveUserSettingsNow();
            janitor?.Dispose();
            qLogger.Dispose();
            Apis.Libs.Sys.FileLogger.Info("Settings.Cleanup() done");
        }
        #endregion
