...
namespace V2RayG.Views.WinForms
{
    ...
    public partial class FormConfiger : Form
    {
        ...
        Apis.WinForms.FormSearch formSearch;
        ...
        private void LoadJsonToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var tuple = Apis.Misc.UI.ReadFileFromDialog(
        ...
        void ExpanseToolsPanel()
        {
            ...
            {
                Apis.Misc.UI.Invoke(() => pnlTools.Width = width);
            }
        }
        ...
        void ShowSearchBox()
        {
            ...
            formSearch = Apis.WinForms.FormSearch.CreateForm(editor.GetEditor());
