...
using V2RayG.Controllers.OptionComponent;
    ...
    public partial class SubscriptionUI : UserControl
    {
        ...
        private void tboxUrl_TextChanged(object sender, EventArgs e)
        {
            ...
            if (settings.isAutoPatchSubsInfo
                ...
                && Apis.Misc.Utils.TryPatchGitHubUrl(url, out var patched))
            {
            ...
            if (string.IsNullOrEmpty(tboxAlias.Text)
                && Apis.Misc.Utils.TryExtractAliasFromSubscriptionUrl(url, out var alias))
            {
        ...
        {
            tboxAlias.Focus();
            var msg = Apis.Misc.Utils.CopyToClipboard(tboxAlias.Text) ?
        ...
        private void lbUrl_Click(object sender, EventArgs e)
        {
            ...
            {
                var clipboard = Apis.Misc.Utils.CopyFromClipboard();
            ...
            {
                tboxUrl.Focus();
                var msg = Apis.Misc.Utils.CopyToClipboard(tboxUrl.Text) ?
                     I18N.CopySuccess : I18N.CopyFail;
                Apis.Misc.UI.MsgBoxAsync(msg);
            }
        }
        ...
        void UpdateTextBoxColorWorker(TextBox textBox, IEnumerable<string> texts)
        {
            ...
            {
                color = Apis.Misc.UI.String2Color(text);
            }
