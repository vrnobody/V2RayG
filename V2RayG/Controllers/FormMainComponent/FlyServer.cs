...
namespace V2RayG.Controllers.FormMainComponent
{
    class FlyServer : FormMainComponentController
    {
        ...
        readonly Apis.Libs.Tasks.LazyGuy
        ...
        public List<Apis.Interfaces.ICoreServCtrl> GetFilteredList()
        {
            ...
            var r = new List<Apis.Interfaces.ICoreServCtrl>();
            for (int i = 0; i < list.Count; i++)
            {
                var s = list[i];
                var st = s.GetCoreStates();
                if (Apis.Misc.Utils.PartialMatchCi(st.GetMark(), keyword)
                    || Apis.Misc.Utils.PartialMatchCi(st.GetRemark(), keyword)
                    || Apis.Misc.Utils.PartialMatchCi(st.GetTitle(), keyword))
                {
                    r.Add(s);
                }
            }
        ...
        public void LoopThroughAllServerUI(Action<Views.UserControls.ServerUI> operation)
        {
            ...
            {
                Apis.Misc.UI.Invoke(() => operation?.Invoke(control));
            }
        }
        ...
        void RefreshFlyPanelWorker(Action done)
        {
            ...
            Action worker = () =>
            {
                ...
                else
                {
                    ...
                    var rmServUis = Apis.Misc.UI.DoHouseKeeping<Views.UserControls.ServerUI>(flyPanel, pagedList.Count);
        ...
        private void BindServUiToCoreServCtrl(
            ...
            List<Apis.Interfaces.ICoreServCtrl> coreServs)
        {
        ...
        List<Apis.Interfaces.ICoreServCtrl> GenPagedServerList(
            List<Apis.Interfaces.ICoreServCtrl> serverList)
        {
        ...
        {
            List<Apis.Interfaces.ICoreServCtrl> flist = GetFilteredList();
            var cpn = Apis.Misc.Utils.Clamp(curPageNumber, 0, totalPageNumber);
        ...
        List<ToolStripMenuItem> CreateDynamicPagingMenu(
            List<Apis.Interfaces.ICoreServCtrl> filteredList,
