...
namespace V2RayG.Controllers.OptionComponent
{
    public class Subscription : OptionComponentController
    {
        ...
        Apis.Libs.Tasks.LazyGuy lazyCounter;
            ...
            Button btnInvertSelection)
        {
            ...
            lazyCounter = new Apis.Libs.Tasks.LazyGuy(UpdateServUiTotalWorker, 1000, 2000)
            {
        ...
        {
            Apis.Misc.UI.Invoke(MarkDuplicatedSubsInfoWorker);
        }
        ...
        public void RemoveSubsUi(Views.UserControls.SubscriptionUI subsUi)
        {
            ...
            foreach (var sub in subs)
            {
                if (sub == subsUi)
                {
                    Apis.Misc.UI.Invoke(() => Remove(subsUi));
                }
            }
        ...
        void BindEventBtnUpdateClick()
        {
            this.btnUpdate.Click += (s, a) =>
            {
                ...
                Apis.Misc.Utils.RunInBackground(() =>
                {
                    ...
                    Apis.Misc.UI.Invoke(() => this.btnUpdate.Enabled = true);
                });
            };
        }
        ...
        int GetAvailableHttpProxyPort()
        {
            ...
            Apis.Misc.UI.MsgBoxAsync(I18N.NoQualifyProxyServer);
