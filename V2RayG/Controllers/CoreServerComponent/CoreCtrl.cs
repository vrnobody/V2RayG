...
namespace V2RayG.Controllers.CoreServerComponent
{
    sealed public class CoreCtrl :
        ...
        Apis.Interfaces.CoreCtrlComponents.ICoreCtrl
    {
        ...
        Apis.Libs.Tasks.Routine bookKeeper;

        Apis.Libs.Tasks.Bar isRecording = new Apis.Libs.Tasks.Bar();
        ...
        public override void Prepare()
        {
            ...
            bookKeeper = new Apis.Libs.Tasks.Routine(RecordStatSample, 3000);
        }
        ...
        public void StopCoreThen(Action next) =>
            Apis.Misc.Utils.RunInBackground(() => StopCoreWorker(next));
        ...
        public void RestartCoreThen(Action next) =>
            Apis.Misc.Utils.RunInBackground(() => RestartCoreWorker(next));

        public bool IsCoreRunning() => v2rayCore.isRunning;

        public void RunSpeedTest() => SpeedTestWorker(configer.GetConfig());

        public void RunSpeedTestThen() => Apis.Misc.Utils.RunInBackground(() =>
        {
        ...
        void SpeedTestWorker(string rawConfig)
        {
            ...
            for (int i = 0; i < cycles && !setting.isSpeedtestCancelled; i++)
            {
                ...
                curDelay = sr.Item1;
                coreStates.AddStatSample(new Apis.Models.Datas.StatsSample(0, sr.Item2));
                ...
                avgDelay = Apis.Misc.Utils.SpeedtestMean(avgDelay, curDelay, Apis.Models.Consts.Config.CustomSpeedtestMeanWeight);
            }
        ...
        void OnLogHandler(object sender, Apis.Models.Datas.StrEvent arg) =>
            logger.Log(arg.Data);
