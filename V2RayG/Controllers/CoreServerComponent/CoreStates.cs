...
namespace V2RayG.Controllers.CoreServerComponent
{
    public class CoreStates :
        ...
        Apis.Interfaces.CoreCtrlComponents.ICoreStates
    {
        Apis.Models.Datas.CoreInfo coreInfo;
        ...
        public void AddStatSample(Apis.Models.Datas.StatsSample sample)
        {
            if (sample == null)
            {
                return;
        ...
        public Apis.Models.Datas.CoreInfo GetAllRawCoreInfo() => coreInfo;
        ...
        public string GetTitle()
        {
            ...
            if (string.IsNullOrEmpty(ci.title))
            {
                ...
                ci.title = Apis.Misc.Utils.AutoEllipsis(result, Apis.Models.Consts.AutoEllipsis.ServerTitleMaxLength);
            }
            return ci.title;
        }

        public Apis.Models.Datas.CoreInfo GetAllInfo() => coreInfo;
        ...
        public string GetLongName()
        {
            ...
            {
                coreInfo.longName = Apis.Misc.Utils.AutoEllipsis(
                    coreInfo.name, Apis.Models.Consts.AutoEllipsis.ServerLongNameMaxLength);
            }
        ...
        public string GetShortName()
        {
            if (string.IsNullOrEmpty(coreInfo.shortName)
                && !string.IsNullOrEmpty(coreInfo.name))
            {
                coreInfo.shortName = Apis.Misc.Utils.AutoEllipsis(
                    coreInfo.name, Apis.Models.Consts.AutoEllipsis.ServerShortNameMaxLength);
            }
