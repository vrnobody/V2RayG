...
namespace V2RayG.Controllers.ConfigerComponet
{
    class MenuUpdater : ConfigerComponentController
    {
            ...
            out List<ToolStripMenuItem> groupedMiReplace)
        {
            ...
            var minDynMenuSize = Apis.Models.Consts.Config.MinDynamicMenuSize;
            ...
            out List<ToolStripMenuItem> groupedMiReplace)
        {
            ...
            groupedMiLoad = Apis.Misc.UI.AutoGroupMenuItems(loadServMiList, groupSize);
            groupedMiReplace = Apis.Misc.UI.AutoGroupMenuItems(replaceServMiList, groupSize);
        }
