...
namespace ProxySetter.Controllers.VGCPluginComponents
{
    class TabStatus : ComponentCtrl
    {
            ...
            Button btnCopy)
        {
            btnViewInNotepad.Click += (s, a) =>
            {
                try
                {
                    ...
                    Apis.Libs.Sys.NotepadHelper.ShowMessage(
                        content, @"PAC.js");
                }
                catch
                {
                    Apis.Misc.UI.MsgBoxAsync(I18N.LaunchNotepadFail);
                }
            };
            ...
            btnDebug.Click +=
                (s, a) => Apis.Misc.UI.VisitUrl(
                    I18N.VisitPacDebugger, GetDebugUrl());

            btnCopy.Click += (s, a) =>
            {
                MessageBox.Show(
                    Apis.Misc.Utils.CopyToClipboard(this.lbPacUrl.Text) ?
        ...
        void OnPacServerStateChangedHandler(object sender, EventArgs args)
        {
            ...
            Apis.Misc.UI.Invoke(() => lbPacServerStatus.Text = text);
        }
