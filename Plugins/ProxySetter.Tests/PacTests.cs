...
namespace ProxySetter.Tests
{
    ...
    public class PacTests
    {
        ...
        {
            Assert.AreEqual(expect, Misc.Utils.IsIP(address));
        }
        ...
        {
            Assert.AreEqual(expect, Misc.Utils.IP2Long(address));
        }
        ...
        public void CompactRangeArrayListTest(string org, string expect)
        {
            ...
            var result = Misc.Utils.CompactCidrList(ref o);
        ...
        {
            var proxyParams = Misc.Utils.GetQureryParamsFrom(
                url == null ? null : (
        ...
        public void OverlapsTest(long aStart, long aEnd, long bStart, long bEnd, Enum.Overlaps expect)
        {
            ...
            var result = Misc.Utils.Overlaps(a, b);
        ...
        {
            var ip = Misc.Utils.Long2Ip(number);
        ...
        {
            var c = Misc.Utils.Cidr2RangeArray(cidr);
            var a = Misc.Utils.Long2Ip(c[0]);
            var b = Misc.Utils.Long2Ip(c[1]);
