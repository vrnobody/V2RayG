...
namespace Pacman.Controllers
{
    class FormMainCtrl
    {
        ...
        List<string> dropableObjectsTypeString = new List<string> {
            ...
            "V2RayG.Views.UserControls.ServerUI",
        };
        ...
        void BindDragDropEvent()
        {
            ...
            flyContent.DragDrop += (s, a) =>
            {
                ...
                var objName = "V2RayG.Views.UserControls.ServerUI";

                if (a.Data.GetDataPresent(objName))
                {
                    var item = (Apis.Interfaces.IDropableControl)a.Data.GetData(objName);
        ...
        void Pack()
        {
            ...
            var strategy = (Apis.Models.Datas.Enums.BalancerStrategies)cboxBalancerStrategy.SelectedIndex;
        ...
        void DeletePackage()
        {
            ...
            if (!Apis.Misc.UI.Confirm(string.Format(I18N.DeleteTpl, name)))
            {
                return;
            }
