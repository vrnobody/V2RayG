...
namespace Luna.Misc
{
    public static class UI
    {
        ...
        public static Scintilla CreateLuaEditor(Panel container)
        {
            ...
            // Keywords
            scintilla.SetKeywords(0, Apis.Models.Consts.Lua.LuaKeywords);

            // Basic Functions

            scintilla.SetKeywords(1,
                Apis.Models.Consts.Lua.ApiFuncNames +
                " " +
                Apis.Models.Consts.Lua.LuaFunctions);

            // String Manipulation & Mathematical
            // Input and Output Facilities and System Facilities
            scintilla.SetKeywords(2, Apis.Models.Consts.Lua.LuaSubFunctions);

            scintilla.SetKeywords(3, Apis.Models.Consts.Lua.LuaModules);
            ...
            Apis.Misc.UI.SetSearchIndicator(scintilla);
