...
namespace Luna.Libs.LuaSnippet
{
        ...
        IEnumerable<AutocompleteItem>
    {
        ...
        string searchPattern = Apis.Models.Consts.Patterns.LuaSnippetSearchPattern;
        ...
        HashSet<string> ignoredList =
            new HashSet<string>(
                Apis.Models.Consts.Lua.LuaKeywords.Split(' '));
        ...
        private IEnumerable<AutocompleteItem> BuildList()
        {
            ...
            if (editor != null)
            {
                Apis.Misc.UI.Invoke(() =>
                {
                    fragment = Apis.Misc.Utils.GetFragment(editor, searchPattern);
                });
            }
