...
{
    public class MailBox : GlobalApis.Interfaces.Lua.ILuaMailBox
    {
        private readonly string myAddress;
        private readonly PostOffice postOffice;

        BlockingCollection<GlobalApis.Models.Datas.LuaMail> mails =
            new BlockingCollection<GlobalApis.Models.Datas.LuaMail>();
        ...
        public GlobalApis.Models.Datas.LuaMail Wait()
        {
            do
            {
        ...
        public GlobalApis.Models.Datas.LuaMail Wait(int milSecs)
        {
        ...
        public GlobalApis.Models.Datas.LuaMail Check()
        {
            try
            {
        ...
        public bool Reply(GlobalApis.Interfaces.Lua.ILuaMail mail, string title) =>
            Reply(mail, title, null);

        public bool Reply(GlobalApis.Interfaces.Lua.ILuaMail mail, string title, string content) =>
            Reply(mail, 0, title, false, content);

        public bool ReplyCode(GlobalApis.Interfaces.Lua.ILuaMail mail, double code) =>
            ReplyCode(mail, code, null);

        public bool ReplyCode(GlobalApis.Interfaces.Lua.ILuaMail mail, double code, string content) =>
            Reply(mail, code, null, false, content);

        public bool ReplyState(GlobalApis.Interfaces.Lua.ILuaMail mail, bool state) =>
            ReplyState(mail, state, null);

        public bool ReplyState(GlobalApis.Interfaces.Lua.ILuaMail mail, bool state, string content) =>
            Reply(mail, 0, null, state, content);

        public bool Reply(GlobalApis.Interfaces.Lua.ILuaMail mail, double code, string title, bool state, string content) =>
        ...
        {
            var mail = new GlobalApis.Models.Datas.LuaMail
            {
                from = myAddress,
                title = title,
                content = content,
        ...
        public bool TryAdd(GlobalApis.Models.Datas.LuaMail mail)
        {
            try
            {
