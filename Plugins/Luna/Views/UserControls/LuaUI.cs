...
namespace Luna.Views.UserControls
{
    internal partial class LuaUI : UserControl
    {
        ...
        Apis.Libs.Tasks.LazyGuy lazyUpdater;
        ...
        {
            lazyUpdater = new Apis.Libs.Tasks.LazyGuy(UpdateUiWorker, 300, 2000)
            {
        ...
        private void removeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(scriptName)
                || !Apis.Misc.UI.Confirm(I18N.ConfirmRemoveScript))
            {
                return;
            }
            ...
            Apis.Misc.Utils.RunInBackground(() =>
            {
                ...
                {
                    Apis.Misc.UI.MsgBoxAsync(I18N.ScriptNotFound);
                }
            });
        }
