...
namespace Luna.Views.WinForms
{
    public partial class FormChoice :
        Form,
        Apis.Interfaces.Lua.IWinFormControl<int>
    {
        ...
        private RadioButton CreateOneChoiceCtrl(int margin, int left, int h, int i)
        {
            ...
            {
                Text = Apis.Misc.Utils.AutoEllipsis(choices[i], MAX_CHOICE_LEN),
                Left = left,
                Top = h * (i + 1) + margin,
                AutoSize = true,
            };
            ...
            control.MouseDoubleClick += (s, a) => Apis.Misc.UI.Invoke(btnOk.PerformClick);
        ...
        private void FormChoice_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                case Keys.Escape:
                    Apis.Misc.UI.CloseFormIgnoreError(this);
                    return;
                case Keys.Enter:
                    // Apis.Misc.UI.Invoke(btnOk.PerformClick);
                    return;
                case Keys.D0:
                    Choose(9);
                    return;
