...
namespace Luna.Controllers.FormEditorCtrl
{
    internal sealed class AutoCompleteCtrl
    {
        ...
        Apis.Libs.Infr.Recorder history = new Apis.Libs.Infr.Recorder();
        Apis.Libs.Tasks.LazyGuy lazyAnalyser;
        ...
        public void Run(Settings settings)
        {
            ...
            lazyAnalyser = new Apis.Libs.Tasks.LazyGuy(AnalizeScriptWorker, 1000, 3000);
        ...
        public void KeyBoardShortcutHandler(KeyEventArgs keyEvent)
        {
            ...
            switch (keyCode)
            {
                case Keys.F12:
                    ...
                    var w = Apis.Misc.Utils.GetWordFromCurPos(editor);
        ...
        {
            UpdateLuaRequireModuleNameSnippets();
            var mn = Apis.Misc.Utils.GetLuaModuleName(e.FullPath);
        ...
        Lua CreateAnalyser()
        {
            ...
            // phony
            anz["Misc"] = new Mock<Apis.Interfaces.Lua.ILuaMisc>().Object;
            anz["Signal"] = new Mock<Apis.Interfaces.Lua.ILuaSignal>().Object;
            anz["Sys"] = new Mock<Apis.Interfaces.Lua.ILuaSys>().Object;
            anz["Server"] = new Mock<Apis.Interfaces.Lua.ILuaServer>().Object;
            anz["Web"] = new Mock<Apis.Interfaces.Lua.ILuaWeb>().Object;
        ...
        void Invoke(Action action) => Apis.Misc.UI.Invoke(action);
        ...
        AutocompleteMenu CreateAcm(Scintilla editor)
        {
            ...
            {
                SearchPattern = Apis.Models.Consts.Patterns.LuaSnippetSearchPattern,
        ...
        private void OnCboxFunctionListDropDownHandler(object sender, EventArgs args)
        {
            ...
            Apis.Misc.UI.Invoke(() =>
            {
                ...
                Apis.Misc.UI.ResetComboBoxDropdownMenuWidth(cboxFunctionList);
            });
        }
        ...
        private void OnCboxVarListDropDownHandler(object sender, EventArgs args)
        {
            ...
            Apis.Misc.UI.Invoke(() =>
            {
                ...
                Apis.Misc.UI.ResetComboBoxDropdownMenuWidth(cboxVarList);
            });
        }
