...
namespace Luna.Controllers.FormEditorCtrl
{
    internal sealed class ButtonCtrl
    {
        ...
        Apis.WinForms.FormSearch formSearch = null;
            ...
            RichTextBox rtboxOutput)
        {
            ...
            logUpdater = new Apis.Libs.Tasks.Routine(
                UpdateOutput,
                Apis.Models.Consts.Intervals.LuaPluginLogRefreshInterval);
        ...
        public void KeyBoardShortcutHandler(KeyEventArgs keyEvent)
        {
            ...
            {
                case Keys.Escape:
                    Apis.Misc.UI.CloseFormIgnoreError(formSearch);
                    break;
                case Keys.F2:
        ...
        public void SetCurrentEditorContent(string content) =>
            Apis.Misc.UI.Invoke(() => editor.Text = content);
        ...
        {
            var keyword = Apis.Misc.Utils.GetWordFromCurPos(editor);
        ...
        void ShowFormSearchHandler(object sender, EventArgs args)
        {
            ...
            formSearch = Apis.WinForms.FormSearch.CreateForm(editor);
        ...
        void UpdateOutput()
        {
            ...
            Apis.Misc.UI.UpdateRichTextBox(rtboxOutput, logs);
        }
        ...
        private void SaveScript(bool showResult)
        {
            ...
            {
                Apis.Misc.UI.MsgBoxAsync(I18N.ScriptNameNotSet);
                return;
            }
        ...
        {
            if (IsChanged() && !Apis.Misc.UI.Confirm(I18N.DiscardUnsavedChanges))
            {
                return;
            }
            preScriptName = "";
