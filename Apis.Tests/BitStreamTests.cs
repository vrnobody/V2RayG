...
namespace Apis.Tests
{
    ...
    {
        Apis.Libs.Streams.BitStream bs;

        public BitStreamTests()
        {
            bs = new Apis.Libs.Streams.BitStream();
        }

        [TestMethod]
        public void Crc8ChecksumFailTest()
        {
            var bs1 = new Apis.Libs.Streams.BitStream();
            bs1.Write(12345);
            ...
            try
            {
                var b2 = new Apis.Libs.Streams.BitStream(b1);
            }
        ...
        public void BsNormalTest()
        {
            ...
            bs1.Dispose();
            var bs2 = new Apis.Libs.Streams.BitStream(b1);
